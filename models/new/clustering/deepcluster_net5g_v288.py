...
__all__ = [ 'deepcluster_net5g_v288']


class DeepClusterNet5gV288Trunk(ResNetTrunk):
    def __init__(self, sobel, input_ch, input_sp_sz):
        super(DeepClusterNet5gV288Trunk, self).__init__()
...
class DeepClusterNet5gV288(ResNet):
    def __init__(self, sobel, out, input_sp_sz, input_ch):
        super(DeepClusterNet5gV288, self).__init__()

        # features, used for pseudolabels
        self.features = DeepClusterNet5gV288Trunk(sobel, input_ch, input_sp_sz)
        self.dlen = 4096
...
def deepcluster_net5g_v288(sobel=False, out=None, input_sp_sz=None,
                         input_ch=None):
    return DeepClusterNet5gV288(sobel, out, input_sp_sz, input_ch)