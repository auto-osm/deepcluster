...
parser.add_argument('--arch', '-a', type=str, metavar='ARCH',
                    choices=['alexnet', 'vgg11', 'deepcluster_net6c',
                             ...
                             'deepcluster_net6c_v288',
                             'deepcluster_net5g_v288',
                             'deepcluster_wideresnet'],
                    required=True)
...
def main():
    ...
    for epoch in range(next_epoch, args.total_epochs):
        ...
        # needs to be n, h, w, dlen
        features = compute_features(dataloader, model, len(dataset))

        # cluster the features
        # treating the features as vectorised, n*h*w, dlen
        # find gt_k dlen centroids,
        # and storing assessment for each pixel
